          ...
          <div className="flex flex-col sm:flex-row items-start gap-12 sm:gap-[269px] w-full lg:w-auto">
            ...
            <div className="flex flex-col items-center gap-6">
              ...
              <div className="flex items-center gap-4">
                {/* WhatsApp Icon */}
                <a href="#" className="w-10 h-10 bg-black rounded-lg flex items-center justify-center hover:bg-[#E04E4E] transition-colors">
                ...
                {/* Email Icon */}
                <a href="mailto:booking@smktelkom-mlg.sch.id" className="w-10 h-10 bg-black rounded-lg flex items-center justify-center hover:bg-[#E04E4E] transition-colors">
                  <svg className="w-5 h-5 text-white" fill="currentColor" viewBox="0 0 24 24">
              ...
              {/* Email Address with Arrow */}
              <div className="flex items-center gap-2">
                <span className="text-[#1F1F1F] text-base font-medium">
                  booking@smktelkom-mlg.sch.id
                </span>
                <svg className="w-4 h-4 text-[#1F1F1F]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
